...
GBIF_ERRORS = {
    u'BASIS_OF_RECORD_INVALID': {
        ...
        u'description': u'The given basis of record is impossible to interpret or seriously different from the recommended vocabulary.'},
    ...
    u'CONTINENT_DERIVED_FROM_COORDINATES': {
        ...
        u'description': u'The interpreted continent is based on the coordinates, not the verbatim string information.'},
    u'CONTINENT_INVALID': {
        u'severity': DQI_MINOR_ERRORS,
    ...
    u'COORDINATE_INVALID': {
        ...
        u'description': u'Coordinate value given in some form but GBIF is unable to interpret it.'},
    u'COORDINATE_OUT_OF_RANGE': {
        u'severity': DQI_MINOR_ERRORS,
        u'title': u'Coordinate out of range',
        u'description': u'Coordinate has invalid lat/lon values out of their decimal max range.'},
    u'COORDINATE_REPROJECTED': {
        u'severity': DQI_MINOR_ERRORS,
        u'title': u'Coordinate reprojected',
        u'description': u'The original coordinate was successfully reprojected from a different geodetic datum to WGS84.'},
    u'COORDINATE_REPROJECTION_FAILED': {
        u'severity': DQI_MINOR_ERRORS,
        u'title': u'Coordinate reprojection failed',
        u'description': u'The given decimal latitude and longitude could not be reprojected to WGS84 based on the provided datum.'},
    u'COORDINATE_REPROJECTION_SUSPICIOUS': {
        u'severity': DQI_MINOR_ERRORS,
        u'title': u'Coordinate reprojection suspicious',
        u'description': u'Indicates successful coordinate reprojection according to provided datum, but which results in a datum shift larger than 0.1 decimal degrees.'},
    ...
    u'COUNTRY_COORDINATE_MISMATCH': {
        ...
        u'description': u'The interpreted occurrence coordinates fall outside of the indicated country.'},
    u'COUNTRY_DERIVED_FROM_COORDINATES': {
        u'severity': DQI_MINOR_ERRORS,
        u'title': u'Country derived from coordinates',
        u'description': u'The interpreted country is based on the coordinates, not the verbatim string information.'},
    u'COUNTRY_INVALID': {
        u'severity': DQI_MINOR_ERRORS,
    ...
    u'COUNTRY_MISMATCH': {
        ...
        u'description': u'Interpreted country for dwc:country and dwc:countryCode contradict each other.'},
    ...
    u'DEPTH_NOT_METRIC': {
        ...
        u'description': u'Set if supplied depth is not given in the metric system, for example using feet instead of meters'},
    u'DEPTH_UNLIKELY': {
        u'severity': DQI_MINOR_ERRORS,
    ...
    u'ELEVATION_NOT_METRIC': {
        ...
        u'description': u'Set if supplied elevation is not given in the metric system, for example using feet instead of meters'},
    u'ELEVATION_UNLIKELY': {
        u'severity': DQI_MINOR_ERRORS,
        u'title': u'Elevation unlikely',
        u'description': u'Set if elevation is above the troposphere (17km) or below 11km (Mariana Trench).'},
    u'GEODETIC_DATUM_ASSUMED_WGS84': {
        u'severity': DQI_MINOR_ERRORS,
        u'title': u'Geodetic datum assumed WGS84',
        u'description': u'Indicating that the interpreted coordinates assume they are based on WGS84 datum as the datum was either not indicated or interpretable.'},
    ...
    u'IDENTIFIED_DATE_INVALID': {
        ...
        u'description': u'The date given for dwc:dateIdentified is invalid and cant be interpreted at all.'},
    u'IDENTIFIED_DATE_UNLIKELY': {
        u'severity': DQI_MINOR_ERRORS,
        u'title': u'Identified date unlikely',
        u'description': u'The date given for dwc:dateIdentified is in the future or before Linnean times (1700).'},
    u'MODIFIED_DATE_INVALID': {
        u'severity': DQI_MINOR_ERRORS,
        u'title': u'Modified date invalid',
        u'description': u'A (partial) invalid date is given for dc:modified, such as a non existing date, invalid zero month, etc.'},
    u'MODIFIED_DATE_UNLIKELY': {
        u'severity': DQI_MINOR_ERRORS,
        u'title': u'Modified date unlikely',
        u'description': u'The date given for dc:modified is in the future or predates unix time (1970).'},
    u'MULTIMEDIA_DATE_INVALID': {
        u'severity': DQI_MINOR_ERRORS,
        u'title': u'Multimedia date invalid',
        u'description': u'An invalid date is given for dc:created of a multimedia object.'},
    ...
    u'RECORDED_DATE_INVALID': {
        ...
        u'description': u'A (partial) invalid date is given, such as a non existing date, invalid zero month, etc.'},
    u'RECORDED_DATE_MISMATCH': {
        u'severity': DQI_MINOR_ERRORS,
        u'title': u'Recorded date mismatch',
        u'description': u'The recording date specified as the eventDate string and the individual year, month, day are contradicting.'},
    u'RECORDED_DATE_UNLIKELY': {
        u'severity': DQI_MINOR_ERRORS,
        u'title': u'Recorded date unlikely',
        u'description': u'The recording date is highly unlikely, falling either into the future or represents a very old date before 1600 that predates modern taxonomy.'},
    ...
    u'TAXON_MATCH_FUZZY': {
        ...
        u'description': u'Matching to the taxonomic backbone can only be done using a fuzzy, non exact match.'},
    u'TAXON_MATCH_HIGHERRANK': {
        u'severity': DQI_MINOR_ERRORS,
        u'title': u'Taxon match higherrank',
        u'description': u'Matching to the taxonomic backbone can only be done on a higher rank and not the scientific name.'},
    u'TAXON_MATCH_NONE': {
        u'severity': DQI_MAJOR_ERRORS,
        u'title': u'Taxon match none',
        u'description': u'Matching to the taxonomic backbone cannot be done cause there was no match at all or several matches with too little information to keep them apart (homonyms).'},
    u'TYPE_STATUS_INVALID': {
        u'severity': DQI_MAJOR_ERRORS,
        u'title': u'Type status invalid',
        u'description': u'The given type status is impossible to interpret or seriously different from the recommended vocabulary.'},
    u'ZERO_COORDINATE': {
        u'severity': DQI_MINOR_ERRORS,
        u'title': u'Zero coordinate',
        u'description': u'Coordinate is the exact 0/0 coordinate, often indicating a bad null coordinate.'}
}
